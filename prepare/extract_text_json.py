...
import requests
import cv2
from pydub import AudioSegment      # 处理音频文件，分割音频
from timeit import default_timer as timer
import pandas as pd
import whisper          # 将语音转换为文本，用于调用模型
...
def main(engine='deepspeech'):
    ...
    parser.add_argument('--model', required=False, default='/home/data02/zhuls24/ABAW/6th/ABAW6/ABAW6-Track4-5/checkpoints/deepspeech-0.9.3-models.pbmm',
    ...
    parser.add_argument('--scorer', required=False, default='/home/data02/zhuls24/ABAW/6th/ABAW6/ABAW6-Track4-5/checkpoints/deepspeech-0.9.3-models.scorer',
    ...
    root = '/home/data2/zls/code/ABAW/emi/dataset/'
